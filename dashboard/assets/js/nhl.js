...
function getTeamName(teamName) {
    const areas = ["Anaheim", "Arizona", "Boston", "Buffalo", "Calgary", "Carolina", "Chicago", "Colorado", "Columbus", "Dallas", "Detroit", "Edmonton", "Florida", "Los Angeles", "Minnesota", "Montreal", "Nashville", "New Jersey", "New York", "New York", "Ottawa", "Philadelphia", "Pittsburgh", "San Jose", "Seattle", "St. Louis", "Tampa Bay", "Toronto", "Vancouver", "Vegas", "Washington", "Winnipeg"]
...
fetch("https://script.google.com/macros/s/AKfycbwtFchPASkZF_kSCAlIr0SQg_oQiREX-lII4i6tOSzeze_2NFd-G39eKTX3s_ktjmSMOQ/exec")
    .then(response => response.text())
    .then(text => {
